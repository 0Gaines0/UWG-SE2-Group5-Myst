...
public class MystiversePage {
    ...
    private void setupComboBox() {
    	...
    	this.sortGenreComboBox.setOnAction((event) -> {
            ...
            if (selectedGenre != null) {
                var filteredGames = Main.getGames().stream().filter(game -> game.getGenres().contains(selectedGenre)).toList();
	...
	private void validateFxml() {
		assert this.allGamesListView != null : "fx:id=\"allGamesListView\" was not injected: check your FXML file 'MystiversePage.fxml'.";
        ...
        assert this.sortGenreComboBox != null : "fx:id=\"sortGenreComboBox\" was not injected: check your FXML file 'MystiversePage.fxml'.";
        assert this.recommendationsButton != null : "fx:id=\"recommendationsButton\" was not injected: check your FXML file 'MystiversePage.fxml'.";
    }
